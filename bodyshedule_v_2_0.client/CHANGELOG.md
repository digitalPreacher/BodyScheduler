...
- Create Angular project with ng: `ng new bodyshedule_v_2_0.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`bodyshedule_v_2_0.client.esproj`).
- Create `launch.json` to enable debugging.
- Create `nuget.config` to specify location of the JavaScript Project System SDK (which is used in the first line in `bodyshedule_v_2_0.client.esproj`).
